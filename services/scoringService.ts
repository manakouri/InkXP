...
import { ScoringCriterion, ScoreAnalysis } from '../types';
import { ADJECTIVES, ALL_SENSORY_WORDS, CONJUNCTIONS, TRANSITIONAL_WORDS } from '../constants';
...
export const ALL_SCORING_CRITERIA: ScoringCriterion[] = [
    {
        id: 'dialogue',
        name: 'Dialogue',
...
export const analyzeScore = (text: string, criteria: ScoringCriterion[]): ScoreAnalysis => {
    let totalScore = 0;
